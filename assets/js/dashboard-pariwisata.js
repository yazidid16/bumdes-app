...
const dataPemasukanPariwisata =
JSON.parse(
   localStorage.getItem("dataPemasukanPariwisata")
) || [];

const dataPengeluaranPariwisata =
JSON.parse(
   localStorage.getItem("dataPengeluaranPariwisata")
) || [];
...
const saldoPariwisata =
document.getElementById("saldoPariwisata");
...
let saldoAkhirPariwisata = 0;

/* =====================================
   HITUNG PEMASUKAN
===================================== */

dataPemasukanPariwisata.forEach(function(item){
...
dataPengeluaranPariwisata.forEach(function(item){
...
saldoPariwisata.textContent =
"Rp " +
saldoAkhirPariwisata.toLocaleString("id-ID");
...
cardPemasukanHariIni.addEventListener(
    ...
    function(){
        ...
        const dataHariIni =
dataPemasukanPariwisata.filter(function(item){
...
.addEventListener(
    ...
    function(){
        ...
        const dataHariIni =
dataPengeluaranPariwisata.filter(function(item){
