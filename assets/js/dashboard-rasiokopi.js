...
const dataPemasukanRasioKopi =
JSON.parse(
   localStorage.getItem("dataPemasukanRasioKopi")
) || [];

const dataPengeluaranRasioKopi =
JSON.parse(
   localStorage.getItem("dataPengeluaranRasioKopi")
) || [];
...
const saldoRasioKopi =
document.getElementById("saldoRasioKopi");
...
let saldoAkhirRasioKopi = 0;

/* =====================================
   HITUNG PEMASUKAN
===================================== */

dataPemasukanRasioKopi.forEach(function(item){
...
dataPengeluaranRasioKopi.forEach(function(item){
...
saldoRasioKopi.textContent =
"Rp " +
saldoAkhirRasioKopi.toLocaleString("id-ID");
...
cardPemasukanHariIni.addEventListener(
    ...
    function(){
        ...
        const dataHariIni =
dataPemasukanRasioKopi.filter(function(item){
...
.addEventListener(
    ...
    function(){
        ...
        const dataHariIni =
dataPengeluaranRasioKopi.filter(function(item){
